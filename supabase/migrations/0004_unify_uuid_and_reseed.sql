...
-- (CREATE OR REPLACE는 return type 변경 불가 → DROP 먼저)
drop function if exists approve_song_change_request(uuid);
create function approve_song_change_request(req_id uuid) returns uuid
